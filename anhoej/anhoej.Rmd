...
As a note on the practical application of the box adjustment of the Anhøj rules, we plan to include a \code{method} argument in the \code{qic()} function of the \CRANpkg{qicharts2} package allowing the user to choose between "anhoej", "bestbox", and "cutbox" methods to identify non-random variation in run and control charts with up to 100 data points.
