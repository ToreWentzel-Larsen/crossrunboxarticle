...
The following notation is introduced to describe the cut box rules. In the right hand vertical border of the best box (L=l) the part retained within the cut box is stated as $C\geq \text{Cbord}$. Similarly in the top horizontal border of the best box (C=c) the part retained within the cut box is stated as $L \leq \text{Lbord}$. For N=11 (Figure \ref{figure:box11}) Cbord=4 and Lbord=6, this is a case in which only the corner is cut. If no cut is done, Cbord and Lbord are not specified, these are the cases inwhich the cut box is identical with the best box.
